      ...
      <div className="relative z-10 flex flex-col items-center justify-center py-16">
        ...
        <p className="text-md sm:text-xl text-gray-600 max-w-3xl mb-10">
          <span className="inline-flex items-center align-middle">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-lock-icon lucide-lock w-4 h-4 sm:w-4.5 sm:h-4.5 mr-2"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg> 
          </span> 
